...
- **Required**
- **Notes:** Must reference valid surface entities in the geometry. Assign the boundaries by selecting from the list using the + button or select graphically in the viewer region.
