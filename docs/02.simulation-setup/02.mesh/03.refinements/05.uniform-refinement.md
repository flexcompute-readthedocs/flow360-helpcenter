...
- **Required**
- **Notes:** Must reference valid box or cylinder entities in the geometry. Assign the box by selecting from the list using the + button or select graphically in the viewer region.
