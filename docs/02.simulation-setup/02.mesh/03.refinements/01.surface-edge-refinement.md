...
- **Required**
- **Notes:** Must reference valid edge entities in the geometry. Assign the edges by selecting from the list using the + button or select graphically in the viewer region.
