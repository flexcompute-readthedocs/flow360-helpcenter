...
- **Cylinder**:
  ...
  - When modeling propulsors or rotating machinery (e.g., rotating mesh or MRF)
  - For creating radial refinement patterns

### Common Applications
- **Volume Zones**: Defining regions for specific flow conditions, e.g., rotating mesh or multiple reference frame (MRF)
- **Local Refinements**: Creating areas of increased mesh resolution

### Implementation Tips
- Volume names are not required to be unique; multiple volumes can have the same name
