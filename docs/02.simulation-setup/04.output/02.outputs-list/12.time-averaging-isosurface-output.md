...
>**Note:** Select only the fields you need for your analysis. See [Available Output Fields](./11.isosurface-output.md#available-output-fields) for a complete list of supported variables.
