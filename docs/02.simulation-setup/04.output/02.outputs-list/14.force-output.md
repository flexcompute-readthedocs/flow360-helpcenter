...
*The size of the moving window (in number of pseudo-steps) over which the statistics function is calculated.*
...
*The step number at which to start calculating the statistics function. This parameter is referenced to the start step of the simulation (pseudo-step 0).*
