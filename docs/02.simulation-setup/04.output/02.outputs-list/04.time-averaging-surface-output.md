...
| *Option* | *Description* |
|----------|---------------|
| **Name** | Name identifier for the time-averaging output | always |
...
- **Notes:** 
  - A descriptive name helps identify this specific output in logs and results.
...
- **Notes:** 
  - You can specify individual surfaces or use pattern matching (e.g., `"wall*"`) to select multiple surfaces.
