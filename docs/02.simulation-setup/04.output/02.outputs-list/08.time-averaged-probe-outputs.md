...
- **Default:** `Time averaging Probe Output` or `Time averaging Surface Probe Output`
...
- **Notes:** Select only the fields you need for your analysis. See [Available Output Fields](./07.probe-outputs.md#-available-output-fields) for a complete list of supported variables.
