...
>**Note:** Select only the fields you need for your analysis. See [Available Output Fields](./07.probe-outputs.md#-available-output-fields) for a complete list of supported variables.
...
>**Note:** Set to a positive integer to save at that interval, or `-1` to save only at the end.
...
>**Note:** With Frequency=`10` and Frequency Offset=`5`, outputs occur at steps `5`, `15`, `25`, etc.
