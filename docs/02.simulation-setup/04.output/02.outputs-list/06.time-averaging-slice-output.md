...
- **Default:** `Time averaging slice output`
- **Example:** `Time Averaged Wing Section`
...
- **Example:** `{"name": "MidSpan", "origin": [0, 0.5, 0], "normal": [0, 1, 0]}`
...
- **Notes:** See detailed field descriptions in the [Slice Output](05.slice-output.md) page. Only select fields you need to analyze to keep file sizes manageable.
