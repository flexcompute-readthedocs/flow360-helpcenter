...
- **Default:** `Surface probe output`
- **Example:** `Wing surface pressure monitors`
- **Notes:** 
  - Choose descriptive names to easily identify outputs when reviewing results.
...
- **Example:** `Cp`, `Cf`, `yPlus`
- **Notes:** 
  - Select only the fields you need for your analysis. Surface-specific variables are available.
...
- **Notes:** 
  - Points are projected to the nearest point on the target surfaces.
...
- **Notes:** 
  - Points are projected to the nearest location on these surfaces. If a point could be projected to multiple surfaces, it will be projected to the closest one.
