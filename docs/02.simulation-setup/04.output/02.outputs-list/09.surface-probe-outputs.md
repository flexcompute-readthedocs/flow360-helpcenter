...
- **Example:** `Cp`, `Cf`, `yPlus`
>**Notes:** surface probe outputs support all [Universal Fields](./00.output-fields.md#universal-fields) and all [Surface Specific Fields](./00.output-fields.md#surface-specific-fields), the same as Surface Outputs. See the [Available Output Fields](./00.output-fields.md) page for a complete reference.
