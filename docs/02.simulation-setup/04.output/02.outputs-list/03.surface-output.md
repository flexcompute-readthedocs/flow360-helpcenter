...
|----------|---------------|--------------|
| **Name** | A descriptive name for the output | always |
...
| **Save interval** | When to save outputs | always | when **Save interval** is `Custom` |
...
- **Example:** `Cp`, `Cf`, `Mach`
- **Notes:** 
  - Select only the fields you need to keep file sizes manageable
...
- **Options:**
  ...
  - `false`
- **Notes:** 
  - Currently only supported for Tecplot format
...
- **Notes:** 
  - Select all appropriate surfaces needed for your analysis
