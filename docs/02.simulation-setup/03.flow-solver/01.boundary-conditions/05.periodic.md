...
|------------|-----------------|----------|
| `Assigned boundaries` | Matching pairs of boundaries to be treated as periodic | always |
| `Periodicity Type` | Type of periodicity (translational or rotational) | always |
| `Rotation Axis` | Axis of rotation for rotational periodicity | `Periodicity type` is `Rotational` |
...
- **Required if `Periodicity Type` is `Rotational`.**
