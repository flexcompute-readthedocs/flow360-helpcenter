...
- **Default:** Model-dependent
- **Example:** `0.01` (1%)
- **Notes:** Used in formula: k = 1.5(U_ref × I)² where k is turbulent kinetic energy, $U_{ref}$ is reference velocity, I is intensity. Typical values: 0.001-0.01 (0.1-1%) for external flows, 0.01-0.1 (1-10%) for internal flows.
