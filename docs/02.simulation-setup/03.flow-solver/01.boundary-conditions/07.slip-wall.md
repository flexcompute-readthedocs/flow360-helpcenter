...
- **Example:** `entities=volume_mesh["frictionless_surfaces"]` or `entities=[auto_farfield.symmetry_planes]`
- **Notes:** Can reference surfaces by name or pattern. Compatible with the `AutomatedFarfield` feature.
