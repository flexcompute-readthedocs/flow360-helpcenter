...
- **Notes:** Assign the boundaries by selecting from the list using the + button or select graphically in the viewer region. Compatible with the `AutomatedFarfield` feature that creates appropriate far-field boundaries.
