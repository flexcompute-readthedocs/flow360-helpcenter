...
|------------|-----------------|----------------|
| `Use operating condition's velocity` | The velocity specified at the boundary condition is the same as in [Operating condition](../../01.flow-conditions/01.operating-condition.md) | always |
...
| `Assigned boundaries` | Geometric boundaries to apply the freestream condition | always |
...
Uses freestream conditions defined in the [Operating condition](../../01.flow-conditions/01.operating-condition.md) section.
...
- **Notes:** - **Notes:** Assign the boundaries by selecting from the list using the + button or select graphically in the viewer region. Compatible with the `AutomatedFarfield` feature that creates appropriate far-field boundaries.
