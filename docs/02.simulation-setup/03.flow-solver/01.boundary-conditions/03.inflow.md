...
| **Total pressure** | Stagnation pressure at the inlet | **Inflow specification** is `Total pressure` or `Supersonic` |
...
| **Static pressure** | Static pressure at the inlet | **Inflow specification** is `Supersonic` |
