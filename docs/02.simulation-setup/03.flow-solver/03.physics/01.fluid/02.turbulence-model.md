...
*Configures the iterative solver solved at each pseudo-step for turbulence equations.*

- **Default:** `max_iterations = 20`
- **Example:** `max_iterations = 40`
>**Notes:**
>- Increasing `max_iterations` can improve robustness at added time cost per pseudo-step
