...
>**Notes:** 
>- Non-dimensional values (normalized by reference velocity scaling $U_{scale}$: speed of sound for `AerospaceCondition`, or reference velocity/velocity magnitude for `LiquidOperatingCondition`)
