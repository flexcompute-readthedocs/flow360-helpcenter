...
*Stopping criterion provides a mechanism to automatically terminate a simulation when a monitored field within reaches a certain value. This is achieved by tracking the deviation of the field over a moving window of iterations. When the deviation falls below a defined tolerance, the simulation is considered converged and stops.*
