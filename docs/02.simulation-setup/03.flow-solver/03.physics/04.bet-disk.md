...
- **Required**
- **Notes:** 
  - The cylinder entity must be properly sized and positioned to represent the rotor disk.
...
- **Notes:** 
  - Determines whether the rotor follows the right-hand or left-hand rule for rotation relative to the thrust axis.
...
- **Range:** `1`-`10`
- **Notes:** 
  - Must be a positive integer, representing the physical blade count of the propeller or rotor.
...
- **Example:** `0.1 m`
- **Notes:** 
  - This value is used in the calculation of sectional thrust and torque coefficients.
...
- **Example:** `20`
- **Notes:** 
  - Recommended value is 20. More nodes provide more detailed radial loading distribution at the cost of computation time.
