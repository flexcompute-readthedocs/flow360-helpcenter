...
mrf_volume.center = (0, 0, 0) * fl.u.m
mrf_volume.axis = (1, 0, 0)
mrf_rotation = fl.Rotation(
    name="steadyRotor",
    volumes=[mrf_volume],
    spec=fl.AngularVelocity(1200 * fl.u.rpm),
