...
- **Example:** `Cylinder(name="actuator_disk", center=(0,0,0), axis=(-1,0,0), height=30, outer_radius=5.0)`
...
- **Default:** None (required parameter)
- **Example:** `ForcePerArea(radius=[0, 1], thrust=[4.1, 5.5], circumferential=[4.1, 5.5])`
- **Notes:** 
...
- **Example:** `[0, 0.25, 0.5, 0.75, 1.0] * u.m`
...
- **Default:** None (required as part of Force Per Area)
- **Example:** `[100, 150, 200, 150, 100] * u.Pa`
