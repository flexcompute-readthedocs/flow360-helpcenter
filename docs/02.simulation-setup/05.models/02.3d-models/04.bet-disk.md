...
- **Example:** `Cylinder(name="bet_disk", center=(0,0,0), axis=(1,0,0), outer_radius=0.5, height=0.03)`
...
- **Default:** None (required parameter)
- **Example:** `812.31 * u.rpm` or `85.06 * u.rad / u.s`
...
- **Default:** "inf"
- **Example:** `0.01 * u.m` or "inf"
- **Notes:** "inf" represents an open propeller with no tip loss reduction from nearby structures. A finite value represents the gap between blade tips and structures like ducts.
...
- **Default:** None (required parameter)
- **Example:** `[BETDiskTwist(radius=0.1*u.m, twist=10*u.deg), BETDiskTwist(radius=0.5*u.m, twist=2*u.deg)]`
...
- **Default:** None (required parameter)
- **Example:** `[BETDiskChord(radius=0.1*u.m, chord=0.05*u.m), BETDiskChord(radius=0.5*u.m, chord=0.03*u.m)]`
...
<details>
<summary><h3 style="display:inline-block"> 📊 Common Applications</h3></summary>
...
<details>
<summary><h3 style="display:inline-block"> 🐍 Python API Usage Example</h3></summary>
