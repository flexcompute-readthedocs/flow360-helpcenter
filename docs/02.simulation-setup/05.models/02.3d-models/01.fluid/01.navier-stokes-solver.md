...
- **What can I do if my simulation is diverging?**  
  > Try the following: (1) Reduce the CFL number, (2) Switch to 1st order accuracy temporarily, (3) Enable limiters for transonic/supersonic flows, (4) Update the Jacobian more frequently (set update_jacobian_frequency = 1), (5) Check the mesh quality, particularly in high-gradient regions.
