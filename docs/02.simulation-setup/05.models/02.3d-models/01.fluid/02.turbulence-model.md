...
- **Python Example:**
  ...
  # No turbulence model (laminar or ILES)
  turbulence_model = NoneSolver()
  ```
- **Notes:** 
...
- **Python Example:**
  ```python
  # Spalart-Allmaras with custom constants
  turbulence_model = SpalartAllmaras(
...
simulation_params = SimulationParams(
    ...
    turbulence_model=sa_model,  # Use the Spalart-Allmaras model defined above
