...
| [`Project tree`](../05.project-tree.md) | <img src="./Figures/project_tree.png" height="32" alt="project tree"/> | Hierarchical view of project components, for more details, refer to this [page](./01.project-tree/) |
...
Details about project tree can be found [here](../05.project-tree.md).
