...
*Volume entities in Flow360 are used to set up volume zones, [local refinements](../../../02.simulation-setup/02.mesh/03.refinements/README.md) and [3D models](../../../02.simulation-setup/03.flow-solver/03.physics/README.md). Flow360 provides two primary volume primitives: boxes and cylinders.*
