...
- **faceId**: A Flow360-generated identifier that indicates the index and hierarchy of a face within the CAD model structure. For example, `faceId = body00002_face00004` means the face belongs to the 4th face of the 2nd body in the CAD model.
