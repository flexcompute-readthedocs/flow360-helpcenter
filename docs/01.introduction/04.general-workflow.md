...
- **Required Steps:**
  ...
  - Output settings
>**Note:** Parameters are organized in collapsible sections for clarity
...
>**Note:** Address any warnings or errors before proceeding
...
>**Note:** Automated meshing is included when starting from geometry
...
>**Note:** Multiple visualization options available
...
>**Note:** Interactive 3D viewport with customizable display settings
