...
- **From geometry:** Upload CAD geometry files, processed through Flow360's automated meshing pipeline.
...
- **From surface mesh:** Use a pre-generated surface mesh file.
  - **Supported formats:** UGrid, CGNS, STL
  - **Requirements:**
    - Valid 3D surface mesh
    - Correct unit system selection
- **From volume mesh:** Use a pre-generated volume mesh file.
