...
|[Project tree](./05.project-tree/README.md)| Description of the project tree and the concept of a project |
...
- **FlexCredits:** Displays your available computation credits and usage.
...
*The Flow360 workbench provides an intuitive interface for CFD simulations, with clearly defined regions for setup, visualization, and analysis.*
...
- **Viewer Bar:** Switches between geometry, mesh, and visualization modes; entity selection tools.
...
- **Structure:** Flexible hierarchy supporting geometry-first, mesh-first, and volume-mesh-first workflows.
