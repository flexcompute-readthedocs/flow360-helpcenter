...
The Reference Area, `refArea`, is used to non-dimensionalize lift coefficient (CL), drag coefficient (CD), force, and moment coefficients. For example:

$$CL = Lift / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea))$$
$$CD = Drag / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea))$$
$$CFx = (X Force) / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea))$$
$$CFy = (Y Force) / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea))$$
$$CFz = (Z Force) / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea))$$
