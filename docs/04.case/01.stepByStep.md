...
For example:
$CL = Lift / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea * L_{gridUnit}^2))$
$CD = Drag / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea * L_{gridUnit}^2))$
$CFx = (X Force) / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea * L_{gridUnit}^2))$
$CFy = (Y Force) / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea * L_{gridUnit}^2))$
$CFz = (Z Force) / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea * L_{gridUnit}^2))$
...
The moment reference lengths are used to non-dimensionalize moment coefficients, according to the definitions below. 
...
For example:
1. $CMx = Mx / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea * L_{gridUnit}^2) * (momentLength_x * L_{gridUnit}))$
2. $CMy = My / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea * L_{gridUnit}^2) * (momentLength_y * L_{gridUnit}))$
3. $CMz = Mz / (1/2 * \rho_{\infty} * U_{ref}^2 * (refArea * L_{gridUnit}^2) * (momentLength_z * L_{gridUnit}))$ 
