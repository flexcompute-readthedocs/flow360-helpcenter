...
see [initial CFL number](/04.case/01.step_by_step/05.timeStepping.html#initial-cfl-number)

## CFL ramping steps

During each non-linear iteration, the CFL number will ramp up from the initial to the final value during this number of CFL ramping steps. If the [maximum number of nonlinear iterations](/04.case/01.step_by_step/05.timeStepping.html#the-maximum-number-of-nonlinear-iterations-used-to-converge-each-physical-time-step) is lower than this number of ramping steps, the final CFL value will be never reached. If the [maximum number of nonlinear iterations](/04.case/01.step_by_step/05.timeStepping.html#the-maximum-number-of-nonlinear-iterations-used-to-converge-each-physical-time-step) is larger than this number of ramping steps, the final CFL value will be reached and used for the rest of the iterations. See the [initial CFL number](/04.case/01.step_by_step/05.timeStepping.html#initial-cfl-number) for more details.