...
*This option is only available when [steady](/04.case/01.step_by_step/05.timeStepping.html#is-the-simulation-steady) is turned off, i.e., simulation is unsteady.*
...
- or when [the maximum number of nonlinear iterations](/04.case/01.step_by_step/05.timeStepping.html#the-maximum-number-of-nonlinear-iterations-used-to-converge-each-physical-time-step) are reached.
