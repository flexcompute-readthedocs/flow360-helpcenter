...
A reference velocity, $U_{ref}$, is used to calculate aerodynamic coefficients, see examples in [refArea](/04.case/01.stepByStep/01.geometry.html#reference-area) and [moment length](/04.case/01.stepByStep/01.geometry.html#moment-length).
...
The side slip angle in degrees, $\beta$. See [alpha](/04.case/01.stepByStep/02.freestream.html#angle-of-attack-alpha-in-deg).
