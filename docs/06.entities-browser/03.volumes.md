...
Volume entities in Flow360 are used to set up [volume zones](./../../02.simulation-setup/02.meshing/02.volume-zone.md), [local refinements](./../../02.simulation-setup/02.meshing/03.refinements/README.md) and [3D models](./../../02.simulation-setup/05.models/02.3d-models/README.md).
...
- **Box**: 
  - For creating mesh refinement zones
- **Cylinder**:
...
- Ensure volumes don't overlap unless specifically intended, e.g., nested refinements or nested rotation
