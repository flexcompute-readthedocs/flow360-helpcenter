...
- **Total Pressure:** Best when:
  - You know the pressure at the inlet (e.g., atmospheric conditions)
  - Flow rate is a result rather than an input
  - For most external aerodynamics applications
  
- **Mass Flow Rate:** Best when:
  - You know the precise flow rate (e.g., from a pump or fan)
  - For HVAC, engine inlets, or other applications with known flow rates
