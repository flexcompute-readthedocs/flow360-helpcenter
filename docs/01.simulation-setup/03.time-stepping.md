...
In the Models section of the UI, you can configure:
...
In the Flow360 UI, you can configure time stepping settings through the Models section:

1. Navigate to the Models section
2. Select the Time Stepping panel
3. Choose between Steady and Unsteady
4. Configure CFL settings (Adaptive is recommended and set as default)
5. Set additional parameters based on your simulation requirements
