...
Face grouping allows you to organize and manage faces in your geometry. You can group edges based on their attributes such as `faceId`, `faceName`, `groupName`.
