...
### cylinder
To define a cylinder refinement zone, you need to set `type` as `cylinder`. Then you need to provide:  
...
5. The rest of the parameters are quite similar to the `rotorDisk` above.  
