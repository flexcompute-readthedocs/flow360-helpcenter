...
3. Here are [the best practices when manually preparing the mesh](https://docs.flexcompute.com/projects/flow360/en/latest/preprocessing/manualMeshing/manualMeshing.html)
