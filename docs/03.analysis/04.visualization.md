...
|--------------|-----------------|
| `Surfaces` | Tab for setting up the contours on the geometry surfaces |
| `Slices` | Tab for setting up the contours on the volume surfaces |
| `Isosurfaces` | Tab for showing and coloring the predefined isosurfaces |
| `Streamlines` | Tab for configuring streamline visibility |
